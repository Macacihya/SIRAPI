            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                <a href="{{ route('walikelas.profil') }}" class="hidden items-center gap-2.5 sm:flex rounded-lg p-1.5 -m-1.5 transition hover:bg-[#f1f5f9]">
                    <div class="text-right">
                        ...
                        <p class="text-[10px] text-[#64748b]">NIP. {{ $user->nip ?? '198501012010012001' }}</p>
                    </div>
                ...
                <a href="{{ route('walikelas.profil') }}" class="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f1f5f9] text-[#94a3b8] sm:hidden transition hover:bg-[#e2e8f0]">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </a>
            </div>
        </header>
