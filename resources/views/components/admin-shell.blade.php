    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 sidebar-scrollbar">
            ...
            <div class="mt-6 border-t border-[#e2e8f0] pt-4">
                <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[13px] font-medium text-[#64748b] transition hover:bg-[#f1f5f9] hover:text-[#0f172a]">
                    <svg class="h-4 w-4 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10" stroke-width="2"></circle>
                        <path d="M12 8v4m0 4h.01" stroke-width="2" stroke-linecap="round"></path>
                    </svg>
                    <span class="leading-tight">Bantuan</span>
                </a>
            </div>
        </nav>
    ...
    <div class="flex min-h-screen flex-col lg:ml-[240px]">
        ...
        >
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                <button aria-label="Pengaturan" class="flex h-9 w-9 items-center justify-center rounded-full border border-[#cbd5e1] text-[#475569] transition hover:bg-[#f1f5f9]" type="button">
                    <svg class="h-[18px] w-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="3" stroke-width="2"></circle>
                        <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke-width="2"></path>
                    </svg>
                </button>
