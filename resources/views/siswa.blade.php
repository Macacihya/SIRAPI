...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <div class="ml-56 flex-1 flex flex-col min-h-screen">
        ...
        <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
            <h1 class="text-base font-semibold text-gray-800">Data Siswa</h1>
        ...
        <main class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div class="bg-white border border-gray-200 rounded-xl p-5">
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-2">Total Siswa</p>
                    <p class="text-3xl font-semibold text-gray-800">{{ count($data) }}</p>
                    <p class="text-xs text-green-600 mt-1">↑ Terdaftar</p>
                </div>
                <div class="bg-white border border-gray-200 rounded-xl p-5">
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-2">Kelas Aktif</p>
                    <p class="text-3xl font-semibold text-gray-800">{{ count(array_unique(array_column($data, 'kelas'))) }}</p>
                    <p class="text-xs text-blue-600 mt-1">Kelas berbeda</p>
                </div>
                <div class="bg-white border border-gray-200 rounded-xl p-5">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-sm font-semibold text-gray-800">Daftar Siswa</h3>
                    <span class="text-xs text-gray-400">{{ count($data) }} data</span>
                </div>
                <table class="w-full text-sm">
                    <the<table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-3 text-gray-800 font-medium">{{ $siswa['nama'] }}</td>
                            <td class="px-6 py-3 text-gray-500">{{ $siswa['nis'] }}</td>
                            <td class="px-6 py-3">
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-400">Belum ada data siswa.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
