{{-- ============================================================
     ...
     Deskripsi: Master layout untuk semua halaman Admin TU.
     Di-extract dari admin-shell.blade.php (component lama)
     menjadi layout tradisional dengan @extends/@yield.

     Menggunakan komponen:
       - <x-admin-navbar> untuk sidebar navigasi
       - Alpine.js untuk toggle sidebar & logout modal
...
<head>
    ...
    <title>@yield('title', 'Dashboard') - SIRAPI Admin TU</title>
...
<body class="min-h-screen bg-[#f0f4f8] text-[#1e293b]" x-data="{ sidebarOpen: false, logoutModalOpen: false }">
    ...
    <x-admin-navbar :active="View::yieldContent('active', 'dashboard')" />
