...
>
    ...
    <div class="mb-8 grid gap-4 grid-cols-1 sm:grid-cols-3">
        ...
        {{-- Card 3 (Diganti dari Rata-rata Perform) --}}
        <section class="rounded-[12px] bg-white px-5 py-5 shadow-[0_1px_0_rgba(0,0,0,0.05)] ring-1 ring-[#e2e8f0]">
            <div class="flex items-center justify-between">
        ...
        <div class="space-y-6 flex flex-col">
            ...
            <div class="flex-1 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-[#e2e8f0]">
                <div class="flex items-center justify-between border-b border-[#f1f5f9] pb-4">
                    ...
                    <a href="{{ route('guru.jadwal-mengajar') }}" class="text-[11px] font-bold text-[#1d4ed8] underline-offset-4 hover:underline">Lihat Kalender</a>
                </div>
                
                <div class="mt-5 space-y-0">
                    {{-- Item 1 --}}
                    <a href="{{ route('guru.jadwal-mengajar') }}" class="group flex items-center justify-between rounded-xl p-3 transition hover:bg-[#f8fafc] hover:shadow-sm cursor-pointer">
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl bg-[#0f172a] p-6 text-white shadow-lg relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <a href="{{ route('guru.penilaian') }}" class="mt-6 flex w-full items-center justify-center rounded-lg bg-white px-4 py-3 text-[12px] font-black uppercase text-[#0f172a] transition hover:bg-[#f8fafc]">
                        Lengkapi Sekarang
                    </a>
                </div>
            </div>
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-[#e2e8f0]">
                ...
                <div class="mt-5 grid grid-cols-2 gap-3">
                    <a href="{{ route('guru.penilaian') }}" class="group flex flex-col items-center justify-center rounded-xl bg-[#f8fafc] p-4 text-center ring-1 ring-[#e2e8f0] transition hover:bg-[#1d4ed8] hover:ring-transparent">
                    ...
                    <a href="{{ route('guru.capaian-kompetensi') }}" class="group flex flex-col items-center justify-center rounded-xl bg-[#f8fafc] p-4 text-center ring-1 ring-[#e2e8f0] transition hover:bg-[#1d4ed8] hover:ring-transparent">
                        <svg class="mb-2 h-6 w-6 text-[#3b82f6] transition group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="text-[11px] font-bold text-[#0f172a] group-hover:text-white">Capaian</span>
                    </a>
                    <a href="{{ route('guru.data-siswa') }}" class="group flex flex-col items-center justify-center rounded-xl bg-[#f8fafc] p-4 text-center ring-1 ring-[#e2e8f0] transition hover:bg-[#1d4ed8] hover:ring-transparent">
                    ...
                    <a href="{{ route('guru.jadwal-mengajar') }}" class="group flex flex-col items-center justify-center rounded-xl bg-[#f8fafc] p-4 text-center ring-1 ring-[#e2e8f0] transition hover:bg-[#1d4ed8] hover:ring-transparent">
