{{-- Halaman: guru-tendik --- menggunakan layout admin --}}
...
@section('content')
user()" active="guru" title="Guru" subtitle="Database Kepegawaian">
<div x-data="{
    search: '',
    roleFilter: 'Semua',
    statusFilter: 'Aktif',
