{{-- Halaman: manajemen-user --- menggunakan layout admin --}}
@extends('layouts.admin')
@section('title', 'Manajemen User')
@section('subtitle', 'Kelola pengguna sistem SIRAPI')
@section('active', 'manajemen-user')

@section('content')
user()" active="manajemen-user" title="Manajemen User" subtitle="Kelola pengguna sistem">
<div x-data="{
    search: '',
    showAdd: false,
    showEdit: false,
        ...
        <div class="w-[90%] max-w-lg rounded-2xl bg-white shadow-2xl" @click.stop>
            ...
            <div class="space-y-4 px-6 py-5">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div><label class="text-[10px] font-bold uppercase tracking-[0.12em] text-[#64748b]">Password</label><input x-model="form.password" class="mt-1 flex h-[42px] w-full rounded-[8px] border border-[#e2e8f0] bg-[#f8fafc] px-4 text-[14px] outline-none focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" type="password"></div>
                </div>
                <div>
