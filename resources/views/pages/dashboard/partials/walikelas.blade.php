{{-- Dashboard Partial: Wali Kelas
     Konten dari pages/walikelas/dashboard-walikelas.blade.php (tanpa <x-walikelas-shell> wrapper)
            ...
            <div class="space-y-4">
                ...
                <div class="grid gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
                    ...
                    <aside class="rounded-[14px] bg-white p-6 ring-1 ring-[#e2e8f0]">
                        ...
                        <a href="{{ route('profil-kelas') }}" class="mt-6 flex h-[46px] w-full items-center justify-center rounded-[4px] border border-[#cbd5e1] bg-white text-[12px] font-extrabold uppercase tracking-[0.12em] text-[#1e40af] transition hover:bg-[#f1f5f9]">
                            Lihat Detail Semua
                        </a>
                    </aside>
                </div>
