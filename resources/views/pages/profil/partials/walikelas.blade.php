            ...
            <div class="space-y-6">
                ...
                <div class="rounded-xl bg-white p-6 ring-1 ring-[#e2e8f0]">
                    ...
                    <div class="mt-5 space-y-5">
                        <div>
                            <p class="text-[11px] font-bold uppercase tracking-[0.14em] text-[#1d4ed8]">Guru Wali Kelas</p>
                            <p class="mt-2 text-[13px] leading-[1.8] text-[#475569]">Pengguna ini memiliki akses sebagai guru mata pelajaran sekaligus akses tambahan sebagai wali kelas untuk memantau dan mengelola data rapor siswa pada kelas yang menjadi tanggung jawabnya.</p>
                        </div>

                        <div>
                            <p class="text-[12px] font-black uppercase text-[#0f172a]">Akses yang Tersedia</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                @foreach (['Dashboard', 'Input Nilai', 'Data Nilai', 'Rekap Nilai', 'Data Siswa Kelas', 'Laporan Rapor', 'Profil Pengguna'] as $akses)
                        ...
                        <div class="space-y-4 border-t border-[#e2e8f0] pt-5">
                            @foreach ([
                                ['title' => 'Guru Mata Pelajaran', 'desc' => 'Menginput dan mengelola nilai siswa sesuai mata pelajaran yang diampu.'],
                                ['title' => 'Wali Kelas', 'desc' => 'Memantau data siswa pada kelas yang menjadi tanggung jawabnya.'],
                                ['title' => 'Laporan Rapor', 'desc' => 'Melihat dan memastikan data nilai, kehadiran, sikap, dan komponen rapor siswa sudah lengkap.'],
                                ['title' => 'Monitoring Kelas', 'desc' => 'Memantau perkembangan akademik siswa dalam kelas sebelum laporan rapor digunakan.'],
                            ] as $item)
