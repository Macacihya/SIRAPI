        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-[14px] text-[#475569]">Semester Ganjil 2023/2024 — <span x-text="['Aditya Ardiansyah','Bagus Pratama','Citra Maharani','Dian Nugraha'][selected]" class="font-semibold text-[#0f172a]">Aditya Ardiansyah</span></p>
                </div>
