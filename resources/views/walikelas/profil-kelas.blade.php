...
>
    ...
    <div class="space-y-8" x-data="{
        ...
        siswa: [
            { no: '01', nis: '12001 / 005432101', init: 'AA', nama: 'ACHMAD ALBAR', jk: 'Laki-laki', role: 'KETUA KELAS' },
            { no: '02', nis: '12002 / 005432102', init: 'BM', nama: 'BELLA MONICA', jk: 'Perempuan', role: 'SEKRETARIS 1' },
            { no: '03', nis: '12003 / 005432103', init: 'DP', nama: 'DANDI PRATAMA', jk: 'Laki-laki', role: 'SISWA' },
            { no: '04', nis: '12004 / 005432104', init: 'EK', nama: 'ENDAH KARTIKA', jk: 'Perempuan', role: 'BENDAHARA 1' },
            { no: '05', nis: '12005 / 005432105', init: 'FA', nama: 'FARHAN AZIS', jk: 'Laki-laki', role: 'SISWA' },
            { no: '06', nis: '12006 / 005432106', init: 'GA', nama: 'GITA ANANDA', jk: 'Perempuan', role: 'SEKRETARIS 2' },
            { no: '07', nis: '12007 / 005432107', init: 'HY', nama: 'HENDRA YULIAN', jk: 'Laki-laki', role: 'SISWA' },
            { no: '08', nis: '12008 / 005432108', init: 'IS', nama: 'INTAN SARI', jk: 'Perempuan', role: 'SISWA' },
            { no: '09', nis: '12009 / 005432109', init: 'JW', nama: 'JOKO WIBOWO', jk: 'Laki-laki', role: 'SISWA' },
            { no: '10', nis: '12010 / 005432110', init: 'KR', nama: 'KIRANA RAHMA', jk: 'Perempuan', role: 'SISWA' },
            { no: '11', nis: '12011 / 005432111', init: 'LP', nama: 'LUKMAN PUTRA', jk: 'Laki-laki', role: 'SISWA' },
            { no: '12', nis: '12012 / 005432112', init: 'MN', nama: 'MAYA NURHALIZA', jk: 'Perempuan', role: 'SISWA' },
            { no: '13', nis: '12013 / 005432113', init: 'NR', nama: 'NANDA RIZKY', jk: 'Laki-laki', role: 'SISWA' },
            { no: '14', nis: '12014 / 005432114', init: 'OP', nama: 'OSCAR PERMANA', jk: 'Laki-laki', role: 'WAKIL KETUA' },
            { no: '15', nis: '12015 / 005432115', init: 'PS', nama: 'PUTRI SETIAWAN', jk: 'Perempuan', role: 'SISWA' },
            { no: '16', nis: '12016 / 005432116', init: 'QH', nama: 'QIYAMUL HAQ', jk: 'Laki-laki', role: 'SISWA' },
            { no: '17', nis: '12017 / 005432117', init: 'RA', nama: 'RINA AGUSTINA', jk: 'Perempuan', role: 'BENDAHARA 2' },
            { no: '18', nis: '12018 / 005432118', init: 'SB', nama: 'SURYA BAGASKARA', jk: 'Laki-laki', role: 'SISWA' },
        ],
