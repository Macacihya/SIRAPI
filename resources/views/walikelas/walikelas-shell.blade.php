        ...
        <header class="border-b border-black/5 bg-white px-5 py-4 sm:px-6 lg:px-10">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div class="flex items-center justify-between gap-4 sm:justify-end">
                    <button class="flex h-10 w-10 items-center justify-center rounded-full border border-black/8 text-[#3a3a3a] transition hover:bg-black/5" type="button" aria-label="Notifikasi">
